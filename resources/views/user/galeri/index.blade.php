    ...
    <div id="modalTambah" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg">
            ...
            <form action="{{ route('user.galeri.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">File Foto <span
                            class="text-red-500">*</span></label>
                ...
                <div class="flex justify-end gap-3 pt-2">
                    ...
                    <button type="submit"
                        class="px-4 py-2 bg-primary text-white rounded-lg text-sm font-semibold hover:bg-primary-700">Upload</button>
                </div>
            </form>
        </div>
    </div>
