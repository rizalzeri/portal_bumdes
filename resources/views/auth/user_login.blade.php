        ...
        <form method="POST" action="{{ route('user.login.post') }}" class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input type="email" name="email" id="email" class="focus:ring-blue-600 focus:border-blue-600 block w-full pl-10 py-3 sm:text-sm border-gray-300 rounded-md border" required value="{{ old('email') }}">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input type="password" name="password" id="password" class="focus:ring-blue-600 focus:border-blue-600 block w-full pl-10 py-3 sm:text-sm border-gray-300 rounded-md border" required>
                </div>
            </div>
            ...
            <div class="mt-4 text-center border-t pt-4 flex flex-col gap-2">
                <a href="{{ route('adminkab.login') }}" class="text-sm font-medium text-gray-500 hover:text-gray-900">Login sebagai Admin Kabupaten</a>
                <a href="{{ route('superadmin.login') }}" class="text-sm font-medium text-gray-500 hover:text-gray-900">Login sebagai Super Admin</a>
            </div>
        </form>
    </div>
</div>
