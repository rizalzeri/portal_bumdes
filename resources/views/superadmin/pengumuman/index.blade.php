...
<div class="mb-6 flex justify-between items-center">
    <div>
        ...
        <p class="text-gray-500 text-sm mt-1">Buat pengumuman yang akan tampil di halaman depan untuk seluruh pengunjung dan BUMDesa.</p>
    </div>
        ...
        <table class="datatable w-full whitespace-nowrap text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 font-bold text-gray-900 whitespace-normal">{{ $p->title }}</td>
                    ...
                    <td class="px-6 py-4 text-right">
                        ...
                        <form action="{{ route('superadmin.pengumuman.destroy', $p->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Hapus pengumuman ini secara permanen?');">
                            @csrf @method('DELETE')
    ...
    <div class="relative top-10 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-xl bg-white">
        ...
        <form action="{{ route('superadmin.pengumuman.store') }}" method="POST" class="space-y-4">
            ...
            <div class="pt-4 border-t flex justify-end gap-2">
                ...
                <button type="submit" class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary hover:bg-primary-900">Publikasikan</button>
            </div>
        </form>
    </div>
</div>
